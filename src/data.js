...
export const webPortfolio = [
  {
    ...
    name: "Online store",
    img: ec,
    desc: "Online store is an E-commerce platform built using the MERN stack (MongoDB, Express.js, React, Node.js) with Redux for state management and Tailwind CSS for styling. The platform includes features for product browsing, user authentication, shopping cart management, and order processing, integrating Paystack as the online payment gateway to handle transactions securely.",
    extra:
  ...
  },
  {
    ...
    img: book,
    desc: "Nation Properties is designed to simplify the process of finding and booking accommodations/rooms. The platform is built using the MERN stack (MongoDB, Express.js, React, Node.js) with Tailwind CSS for styling.These sites provide a central location where customers can browse through available properties, view photos and  book accommodations online.",
    extra:
